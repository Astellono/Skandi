...
<body>
    ...
    <section class="section team">
        <div class="container">
            ...
            <ul class="team__list">
                ...
                <li class="team__item">
                    <img class="team__img" src="img/team/3.png" alt="">
                    <h3 class="team__title-member">Краснова Елена</h3>
                    <p class="team__desc">Инструктор</p>
 ...
 -->
    ...
    <div class="modal fade" id="modal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <img class="team__img team__modal-img" src="img/team/3.png" alt="">
                <div class="modal-body">
                    Краснова Елена
                </div>
                <div class="modal-footer">
                    <p class="modal-desc">
                        Лет пять назад я поняла, что скандинавская ходьба, это то, чем я хочу заниматься в качестве
                        физической активности. Стала ходить в группу у себя в районе. Потом, в 2019 г., прошла обучение
                        в RNWA. С тех пор моя жизнь тесно связана со скандинавской ходьбой
                        уже в качестве сертифицированного инструктора. Я постоянно совершенствую свои знания в этой
                        области (кстати, сейчас опять учусь ☝️😀) и с радостью делюсь этими знаниями. Уже несколько лет
                        я провожу групповые и индивидуальные занятия,
                        организую экскурсии и туры со скандипалочками.<br> Занятия проходят на Воробьёвых горах, в парке
                        Дворца пионеров, в Нескучном саду, в парке Теплый стан, в Битцевском парке.
                    </p>
                    <div class="modal-diplome">
                        <hr>
                        <h3 class="modal-diplome-title">Дипломы</h3>
