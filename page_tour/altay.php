        ...
        <div class="container order__container">
            <div class="order__contant">
                <div class="tour__page__pricePart">
                    <p class="tour__page__price">Стоимость: 109 700 рублей <br> Группа до 12 человек </p>
    ...
    <div onclick="location.href='#'" id="openModal" class="mod">
        <div onclick="event.stopPropagation()" class="modal-d">
            <div class="modal-c">
                ...
                <div class="modal-b">
                    <form action="/php/tour/sendTour.php?name=Алтай" method="POST" class="modal__form">
