                ...
                <div class="tour__page__imgBox">
                    ...
                    <div class="tour__page__titleBox">
                        <h1 class="tour__page__title">
                            Тур: «Дыхание Казахстана: Алматинские горы и легенды Великой Степи»
                        </h1>
                        <h2 class="tour__page__date">Даты: 4 – 11 октября 2026г</h2>
                    </div>
        ...
        <div class="container order__container">
            <div class="order__contant">
                <div class="tour__page__pricePart">
                    <p class="tour__page__price">Стоимость: 1405 долларов <br>Группа 8-12 человек</p>
