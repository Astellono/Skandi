...
<head>
    ...
    <meta name="description"
        content="Торжок: Императорский шаг — тур скандинавской ходьбы по пушкинским местам.">
        ...
        <div class="container">
            ...
            <div class="tour__page__infoBlock">
                ...
                <p class="tour__page__desc">
                    ...
                    скандинавской ходьбы мы пройдем по следам Николая Львова, Александра Пушкина и купцов Новоторов. <br>
                    Нас ждут:<br><br>
            ...
            <ul class="modal-tour-list accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div id="flush-collapse1" class="accordion-collapse collapse" aria-labelledby="flush-heading1"
                        ...
                        <div class="accordion-body">
                            <ul class="modal-active-list">
                                <li class="modal-active-item">18:30 – Сбор группы и отправление от м. Ховрино на комфортабельном микроавтобусе.</li>
                                <li class="modal-active-item">Остановка для перекуса в дорожном кафе (за доп. плату).</li>
                                <li class="modal-active-item">~22:30 – Прибытие в Торжок. Заселение в гостиницу «Оникс». Отдых.</li>
                            </ul>
                        </div>
                    </div>
                </li>
                    ...
                    <div id="flush-collapse2" class="accordion-collapse collapse" aria-labelledby="flush-heading2"
                        ...
                        <div class="accordion-body">
                            <ul class="modal-active-list">
                                ...
                                <li class="modal-active-item">10:00 – Пешая экскурсия по Торжку: памятник Львову, часовня, магистрат, храмы Спасский и Входоиерусалимский (работы Львова), валы Кремля, смотровая площадка.</li>
                                <li class="modal-active-item">Посещение Борисоглебского монастыря, Тихвинской деревянной церкви, Путевого дворца.</li>
                                <li class="modal-active-item">14:00 – Обед в монастырской трапезной (за доп. плату).</li>
                                <li class="modal-active-item">Переезд в усадьбу «Грузины»: каменный мост, система прудов, руины.</li>
                                <li class="modal-active-item">Возвращение в Торжок. По выбору: Музей золотного шитья или Музей А.С. Пушкина.</li>
                                <li class="modal-active-item">Вечер: прогулка по набережной, гостиница Пожарских. Ужин (за доп. плату).</li>
                            </ul>
                        </div>
                    </div>
                </li>
                ...
                <li class="modal-tour-item accordion-item">
                    ...
                    <div id="flush-collapse3" class="accordion-collapse collapse" aria-labelledby="flush-heading3"
                        ...
                        <div class="accordion-body">
                            <ul class="modal-active-list">
                                <li class="modal-active-item">8:00 – Утренняя зарядка. Завтрак. Освобождение номеров.</li>
                                <li class="modal-active-item">10:00 – Осмотр гостиницы Пожарских и посещение Музея фарфора.</li>
                                <li class="modal-active-item">Переезд в усадьбу «Раёк». Экскурсия по усадьбе и прогулка по парку (за доп. плату).</li>
                                <li class="modal-active-item">Обед в кафе по пути в Москву (за доп. плату). Трансфер в Москву.</li>
            ...
            <div class="order__contant">
                <div class="tour__page__pricePart">
                    ...
                    <p class="tour__page__priceIn">В стоимость входят:
                        Проезд на комфортабельном микроавтобусе, размещение в гостинице «Оникс» (2‑местные номера, санузел в номере),
                        питание: 2 завтрака, сопровождение инструктора по скандинавской ходьбе, все экскурсии по программе (кроме музеев, оплачиваемых дополнительно), радиогиды.
                    </p>
    ...
    <div onclick="location.href='#'" id="openModal" class="mod">
        <div onclick="event.stopPropagation()" class="modal-d">
            <div class="modal-c">
                ...
                <div class="modal-b">
                    <form action="/php/tour/sendTour.php?name=Торжок" method="POST" class="modal__form">
