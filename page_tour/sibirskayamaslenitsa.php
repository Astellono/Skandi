...
$tourData = getTourPageData($connect, $currentPagePath, [
    'name' => 'Тур «Сибирская Масленица: Тобольск в ритме скандинавской ходьбы»',
    'date' => '',
    'price' => '63100/73900 р'
]);
...
<head>
    ...
    <meta name="description" content="Отправляйтесь навстречу сибирской зиме и самому яркому празднику! Этот тур создан для тех, кто любит активный отдых, пешие прогулки и скандинавскую хо...">
    ...
    <title><?php echo htmlspecialchars($tourData['name'] ?? 'Тур «Сибирская Масленица: Тобольск в ритме скандинавской ходьбы»', ENT_QUOTES, 'UTF-8'); ?></title>
</head>
...
<body>
        ...
        <div class="container">
            ...
            <div class="tour__page__header">
                ...
                <div class="tour__page__imgBox">
                    ...
                    <img class="tour__page__img" src="<?php echo htmlspecialchars($tourImgPath, ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($tourData['name'] ?? 'Тур «Сибирская Масленица: Тобольск в ритме скандинавской ходьбы»', ENT_QUOTES, 'UTF-8'); ?>">
                    <?php else: ?>
                    <img class="tour__page__img" src="../img/act-tour/default.jpg" alt="<?php echo htmlspecialchars($tourData['name'] ?? 'Тур «Сибирская Масленица: Тобольск в ритме скандинавской ходьбы»', ENT_QUOTES, 'UTF-8'); ?>">
                    <?php endif; ?>
                    <div class="tour__page__titleBox">
                        <h1 class="tour__page__title">
                            <?php echo htmlspecialchars($tourData['name'] ?? 'Тур «Сибирская Масленица: Тобольск в ритме скандинавской ходьбы»', ENT_QUOTES, 'UTF-8'); ?>
                        </h1>
        ...
        <div class="container order__container">
            <div class="order__contant">
                <div class="tour__page__pricePart">
                    <p class="tour__page__price">Стоимость: <?php echo htmlspecialchars($tourData['price'] ?? '63100/73900 р', ENT_QUOTES, 'UTF-8'); ?><?php 
    ...
    <?php 
        ...
        if (!empty($fullTourData['formTour_param'])) {
            ...
            $formTourParam = htmlspecialchars($tourData['name'] ?? 'Тур «Сибирская Масленица: Тобольск в ритме скандинавской ходьбы»', ENT_QUOTES, 'UTF-8');
        }
