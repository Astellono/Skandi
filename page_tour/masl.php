...
$tourData = getTourPageData($connect, $currentPagePath, [
    ...
    'date' => '19 – 23 февраля 2026г.',
    'price' => '63 100 рублей / 73 900 рублей'
]);
$dateText = $tourData['date']
    ? 'Даты: ' . htmlspecialchars($tourData['date'], ENT_QUOTES, 'UTF-8')
    : 'Даты: 19 – 23 февраля 2026г.';
        ...
        <div class="container order__container">
            <div class="order__contant">
                <div class="tour__page__pricePart">
                    <p class="tour__page__price">Стоимость: <?php echo htmlspecialchars($tourData['price'] ?? '63 100 рублей (при двухместном размещении) / 73 900 рублей (при одноместном размещении)', ENT_QUOTES, 'UTF-8'); ?><br>Группа 10-12 человек</p>
