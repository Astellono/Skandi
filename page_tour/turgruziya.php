...
<head>
    ...
    <meta name="description" content="Сентябрь в Грузии &mdash; это время, когда воздух наполнен ароматом спелого винограда, а солнце ласкает кожу уже нежным, бархатным теплом. Это идеальн...">
    ...
    <title><?php echo htmlspecialchars($tourData['name'] ?? 'Тур: «Грузия в бархатный сезон: вино, стиль и сезон ртвели»', ENT_QUOTES, 'UTF-8'); ?></title>
</head>
...
<body>
        ...
        <div class="container">
            ...
            <div class="tour__page__header">
                ...
                <div class="tour__page__imgBox">
                    ...
                    <img class="tour__page__img" src="<?php echo htmlspecialchars($tourImgPath, ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($tourData['name'] ?? 'Тур: «Грузия в бархатный сезон: вино, стиль и сезон ртвели»', ENT_QUOTES, 'UTF-8'); ?>">
                    <?php else: ?>
                    <img class="tour__page__img" src="../img/act-tour/default.jpg" alt="<?php echo htmlspecialchars($tourData['name'] ?? 'Тур: «Грузия в бархатный сезон: вино, стиль и сезон ртвели»', ENT_QUOTES, 'UTF-8'); ?>">
                    <?php endif; ?>
        ...
        <div class="container order__container">
            <div class="order__contant">
                <div class="tour__page__pricePart">
                    <p class="tour__page__price">Стоимость: <?php echo htmlspecialchars($tourData['price'] ?? '1015 долларов', ENT_QUOTES, 'UTF-8'); ?><?php 
    ...
    <?php 
        ...
        if (!empty($fullTourData['formTour_param'])) {
            ...
            $formTourParam = htmlspecialchars($tourData['name'] ?? 'Тур: «Грузия в бархатный сезон: вино, стиль и сезон ртвели»', ENT_QUOTES, 'UTF-8');
        }
