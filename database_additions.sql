...
CREATE TABLE IF NOT EXISTS `tours` (
  ...
  `tour_color` varchar(50) DEFAULT NULL,
  `tour_date_start` date DEFAULT NULL,
  `tour_date_end` date DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`tour_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ALTER TABLE `tours` ADD COLUMN `tour_color` VARCHAR(50) DEFAULT NULL AFTER `tour_imgSrc`;
-- ALTER TABLE `tours` ADD COLUMN `tour_date_start` DATE DEFAULT NULL AFTER `tour_color`;
-- ALTER TABLE `tours` ADD COLUMN `tour_date_end` DATE DEFAULT NULL AFTER `tour_date_start`;
