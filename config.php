...
$host = 'localhost'; // или IP сервера Timeweb, например: '185.68.21.123'

// Порт базы данных (обычно 3306 для MySQL)
$port = 3306;

// Имя пользователя базы данных (из панели Timeweb)
$username = 'your_username'; // Замените на ваше имя пользователя БД

// Пароль базы данных (из панели Timeweb)
$password = 'your_password'; // Замените на ваш пароль БД

// Название базы данных
$database = 'your_database'; // Замените на название вашей БД
